  ...
  if (isLoading) {
    ...
    return (
      <div key={service.id}>
        ...
        >
          {service != null && service.id != 3 && service.id != 4 && (
              ...
              <Link to={`/service/${service.id}`}>
                ...
                <CardBody>
                  ...
                  {service.serviceCategory ? (
                    <CardSubtitle>{service.serviceCategory}</CardSubtitle>
                  ) : null}
                  Service Label:{" "}
                  {service.serviceLabel ? (
                    <CardSubtitle>{service.serviceLabel}</CardSubtitle>
                  ) : null}
                  Service Rating:{" "}
                  {service.serviceRating ? (
                    <CardSubtitle>{service.serviceRating}</CardSubtitle>
                  ) : null}
                  Service Description:{" "}
